...
<body>
    ...
    echo "Resuldado da potenciação é $potenciacao <br>";
    echo "resultado da divisão é $divisao <br>";
    echo "resultado do resto da divisão de $a e $B é $restodivicao <br>"; 
    ...
    $preco_formatado = number_format($preco, 2, ',', '.');
     ...
     echo(!$teste) ? "È verdadeiro." : "È falso";
     ...
     echo($tem_ingresso or $tem_convitevip) ? "Você pode entrar na festa." : "Você não pode entrar na desta.";
     echo"<br>";
